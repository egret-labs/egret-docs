...
答：目前我们只支持白鹭引擎 5.2.17 以上的版本发布为小米快游戏。[参考微信小游戏升级指南](http://developer.egret.com/cn/github/egret-docs/Engine2D/minigame/publish/index.html) 
...
答：升级成功后，请首先保证 HTML5 版本可以正常运行，然后再尝试发布为小米快游戏，目前我们遇到了多位开发者通过创建 5.2.17 新项目后拷贝老项目代码和素材的方式尝试升级，由于忽视了修改 egretProperties.json 中的模块配置，导致运行失败的问题。[参考微信小游戏升级指南](http://developer.egret.com/cn/github/egret-docs/Engine2D/minigame/publish/index.html)
